...
function(global, setTimeout) {
	...
	function mixin(i, e, r, n) {
		return e && eachProp(e,
		function(e, t) { ! r && hasProp(i, t) || (!n || "object" != typeof e || !e || isArray(e) || isFunction(e) || e instanceof RegExp ? i[t] = e: (i[t] || (i[t] = {}), mixin(i[t], e, r, n)))
		}),
		i
	}
	function bind(e, t) {
	...
	function newContext(u) {
		...
		function q(e, t, i) {
			...
			h = g.map,
			m = h && h["*"];
			if (e && (u = (e = e.split("/")).length - 1, g.nodeIdCompat && jsSuffixRegExp.test(e[u]) && (e[u] = e[u].replace(jsSuffixRegExp, "")), "." === e[0].charAt(0) && l && (e = l.slice(0, l.length - 1).concat(e)),
			function(e) {
				var t, i;
				for (t = 0; t < e.length; t++) if ("." === (i = e[t])) e.splice(t, 1),
				t -= 1;
				else if (".." === i) {
		...
		function w(e) {
			...
			if (t && isArray(t) && 1 < t.length) return t.shift(),
			l.require.undef(e),
			l.makeRequire(null, {
				skipMap: !0
			})([e]),
		...
		function S(e, t, i, r) {
			...
			e && (u ? f = i ? e: o && o.normalize ? o.normalize(e,
			function(e) {
				return q(e, c, r)
		...
		function R() {
			...
			if (!i) {
				...
				function(e) {
					var t = e.map,
					i = t.id;
					if (e.enabled && (t.isDefine || a.push(e), !e.error)) if (!e.inited && n) w(i) ? s = r = !0 : (o.push(i), E(i));
				...
				function(e) { !
					function n(o, a, s) {
						var e = o.map.id;
						o.error ? o.emit("error", o.error) : (a[e] = !0, each(o.depMaps,
						function(e, t) {
							var i = e.id,
		...
		(e = function(e) {
						...
						if (this.error) this.emit("error", this.error);
							...
							if (this.defining = !0, this.depCount < 1 && !this.defined) {
								if (isFunction(o)) {
									...
									if (this.map.isDefine && void 0 === n && ((e = this.module) ? n = e.exports: this.usingExports && (n = this.exports)), t) return t.requireMap = this.map,
			...
			callPlugin: function() {
				...
				function(e) {
					...
					function(e) {
						return q(e, a, !0)
					}) || ""), M(t = S(u.prefix + "!" + n, this.map.parentMap, !0), "defined", bind(this,
					function(e) {
					...
					})), void((i = getOwn(p, t.id)) && (this.depMaps.push(t), this.events.error && i.on("error", bind(this,
					function(e) {
						this.emit("error", e)
					})), i.enable()))) : r ? (this.map.url = l.nameToUrl(r), void this.load()) : ((o = bind(this,
					function(e) {
						this.init([],
						function() {
							return e
			...
			enable: function() { (f[this.map.id] = this).enabled = !0,
				this.enabling = !0,
				...
				function(e, t) {
					...
					if ("string" == typeof e) {
						...
						this.errback ? M(e, "error", bind(this, this.errback)) : this.events.error && M(e, "error", bind(this,
						function(e) {
							this.emit("error", e)
						}))
					}
		...
		(l = {
			...
			makeRequire: function(o, a) {
				function s(e, t, i) {
					...
					"string" == typeof e ? isFunction(t) ? O(makeError("requireargs", "Invalid require call"), i) : o && hasProp(c, e) ? c[e](p[o.id]) : req.get ? req.get(l, e, o, s) : (r = S(e, o, !1, !0).id, hasProp(m, r) ? m[r] : O(makeError("notloaded", 'Module name "' + r + '" has not been loaded yet for context: ' + u + (o ? "": ". Use require([])")))) : (T(), l.nextTick(function() {
						T(),
				...
				mixin(s, {
					...
					toUrl: function(e) {
						...
						r = e.split("/")[0];
						return - 1 !== i && (!("." === r || ".." === r) || 1 < i) && (t = e.substring(i, e.length), e = e.substring(0, i)),
...
Object.assign(requirejs,{
	...
	__importGlobal__:function(paramObj){
		Object.assign(this.__path__,paramObj);
		this.__path_format__();
		this.config({
			  paths: this.__path_fix__,
			  shim: {					
			  },
		})
	},
	__path_format__: function(){
		var __path__ = this.__path__;
		//序列化__path__
		for(var key in __path__){
			this.__path_fix__[key]=__path__[key].replace(/\.css|\.js/g, "");
		}	
	},
	__autowired__: function(importArr){
		return importArr.map((key)=>{
			return this.__import_module__(key);
		})
	},
	__import_module__ : function(key){
		var __path__ = this.__path__
		var __required__ = this.__required__
		var modulename_format
		// 如果已经导入过 那么直接可以引用上次的键名
		if (__required__[__path__[key]]) {
		  return __required__[__path__[key]]
		}
		if (/\.html$/.test(__path__[key])) {
		  modulename_format = "text!" + key
		} else if (/\.css$/.test(__path__[key])) {
		  modulename_format = "css!" + key
		} else {
		  modulename_format = key
		}
		__required__[__path__[key]] = modulename_format
		return modulename_format
	},
	
})
requirejs.__importGlobal__ = requirejs.__importGlobal__.bind(requirejs);
requirejs.__path_format__  = requirejs.__path_format__.bind(requirejs);
requirejs.__autowired__    = requirejs.__autowired__.bind(requirejs);
requirejs.__import_module__= requirejs.__import_module__.bind(requirejs);

/*冻结属性防止被修改*/
Object.freeze(requirejs);
